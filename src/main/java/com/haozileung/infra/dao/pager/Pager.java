package com.haozileung.infra.dao.pager;
...
import com.haozileung.infra.dao.bean.BeanConverter;
	...
	public <E> List<E> getList(Class<E> clazz) {
		if (clazz == null) {
			throw new IllegalArgumentException(
					"Conversion failed,Parameter class can not be null!");
		}
