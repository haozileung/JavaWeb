...
public class Criteria {
	...
	public Criteria asc(String... field) {
		for (String f : field) {
			AutoField autoField = this.buildAutoFields(f, null, "ASC",
					AutoField.ORDER_BY_FIELD);
	...
	public Criteria desc(String... field) {
		for (String f : field) {
			AutoField autoField = this.buildAutoFields(f, null, "DESC",
					AutoField.ORDER_BY_FIELD);
			this.orderByFields.add(autoField);
		}
		return this;
	...
	public Criteria set(String fieldName, Object value) {
		AutoField autoField = this.buildAutoFields(fieldName, null, "=",
				AutoField.UPDATE_FIELD, value);
	...
	public Criteria setPKValueName(String pkName, String valueName) {
		AutoField autoField = this.buildAutoFields(pkName, null, "=",
	...
	public Criteria or(String fieldName, String fieldOperator, Object[] values) {
		AutoField autoField = this.buildAutoFields(fieldName, "or",
				fieldOperator, AutoField.WHERE_FIELD, values);
		this.autoFields.add(autoField);
		return this;
	}
	 ...
	 * @return
	 */
	private AutoField buildAutoFields(String fieldName, String sqlOperator,
