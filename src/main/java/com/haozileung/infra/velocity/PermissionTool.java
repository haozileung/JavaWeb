...
/**
 * <p>
 * velocity shiro support 用于在velocity模板判断权限，例如 $shiro.hasPermission("user:add")
 * </p>
 * 创建时间：2014年9月18日 上午10:32:36
 *
 * @author lianghaopeng
 * @version V1.0
 */
...
public class PermissionTool {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(PermissionTool.class);
			...
			try {
				...
				for (PropertyDescriptor pd : bi.getPropertyDescriptors()) {
					if (pd.getName().equals(property)) {
						value = pd.getReadMethod().invoke(principal,
								(Object[]) null);
						foundProperty = true;
						break;
					}
