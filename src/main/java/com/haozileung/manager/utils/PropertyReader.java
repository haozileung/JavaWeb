...
public abstract class PropertyReader {
	 ...
	 * @return 属性
	 */
	public final static Properties getProperties(Class<?> cls,
	 ...
	 * @return
	 */
	public final static String getValue(Class<?> cls, String propertyFilePath,
			String key) {
	 ...
	 * @return
	 */
	private static Properties loadPropertyFile(Class<?> cl,
			String propertyFilePath) {
		InputStream is = null;
		if (cl == null)
			is = getClassLoader(PropertyReader.class).getResourceAsStream(
					propertyFilePath);
		if (cl == null)
