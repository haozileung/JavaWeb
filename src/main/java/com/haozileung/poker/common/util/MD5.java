...
　　　　　 字节拷贝到output之outpos位置开始
        ...
        */
        ...
        /*Encode把long数组按顺序拆成byte数组，因为java之long类型是64bit之，
          只拆低32bit，以适应原始C实现之用途
        */
        ...
        /*Decode把byte数组按顺序合成成long数组，因为java之long类型是64bit之，
          只合成低32bit，高32bit清零，以适应原始C实现之用途
        */
        ...
        /*
          b2iu是我写之一个把byte按照不考虑正负号之原则之＂升位＂程序，因为java没有unsigned运算
        */
        public static long b2iu(byte b) {
                return b < 0 ? b & 0x7F + 128 : b;
        }

/*byteHEX()，用来把一个byte类型之数转换成十六进制之ASCII表示，
　因为java中之byte之toString无法实现这一点，我们又没有C语言中之
